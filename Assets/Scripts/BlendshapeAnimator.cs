...
public class BlendshapeAnimator : MonoBehaviour
{
    ...
    Vector3 initialVectorEyeLeft = new Vector3(0.00f, 270.00f, 180.00f);
    Transform eyeRightBone;
    Vector3 initialVectorEyeRight = new Vector3(0.00f, 270.00f, 180.00f);
    float frameTime;
    ...
    public void PrepareFExpression(float time, int index)
    {
        ...
        if (index < corFrames.Count) {
            ...
            {
                frameTime = (time - curFrame.timestamp) / 0.040f;
            }
